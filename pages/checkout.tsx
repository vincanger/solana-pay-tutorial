...
export default function Checkout() {
  ...
  console.log('reference AFTER converting to string-->', reference.toString());

  for (const values of searchParams.entries()) {
    console.log(values)
  }
  console.log('search params entries toString', searchParams.toString())
  ...
  async function getTransaction() {
    ...
    console.log('[][][ success ][]][] response transaction after being deserialized from base64 -> ', transaction);
  }
